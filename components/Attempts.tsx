...
export default function Attempts({ item }: { item: string }) {
  ...
  return (
    <View
      className="flex flex-row items-center justify-between bg-white w-full rounded-xl shadow-sm shadow-white p-4 mb-3"
      style={{ padding: 22 }}
    >
      <View className="flex flex-row items-center">
        <FontAwesome5 name="star" size={24} color="#d97706" className="mr-3" />
      </View>
